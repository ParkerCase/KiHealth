...
with open(
    "/Users/parkercase/starx-therapeutics-analysis/data/raw/depmap/OmicsSomaticMutationsMatrixHotspot.csv",
    "r",
) as f:
    reader = csv.reader(f)
    header = next(reader)
...
with open(
    "/Users/parkercase/starx-therapeutics-analysis/data/raw/depmap/CRISPRGeneDependency.csv",
    "r",
) as f:
    reader = csv.reader(f)
    header = next(reader)
...
df_model = pd.read_csv(
    "/Users/parkercase/starx-therapeutics-analysis/data/raw/depmap/Model.csv",
