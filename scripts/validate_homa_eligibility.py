...
# Summary statistics (valid for HOMA modeling = eligible AND not invalid)
print("\n" + "=" * 70)
print("SUMMARY:")
print("=" * 70)
total_eligible = int((df.homa_analysis_eligible & ~df.invalid_homa_flag).sum())
print(f"Total HOMA-eligible (valid for modeling): {total_eligible}")
print("Expected: 35,444 HOMA-eligible (33,078 used for training)")

if total_eligible >= 33000:
    print("\n✅ ALL VALIDATION CHECKS PASSED")
else:
    print(f"\n❌ VALIDATION FAILED: Expected ≥33,078 HOMA-eligible for training, got {total_eligible}")
