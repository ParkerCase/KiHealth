...
# Age-adjusted Beta Score reference ranges, generated by
# scripts/m2b/19_age_adjusted_reference_ranges.py. Every value is an empirical
# percentile of not-at-risk patients; nothing here is a hardcoded threshold.
AGE_REFERENCE_FILENAME = "age_adjusted_reference_ranges.json"
AGE_REFERENCE_CANDIDATES = (
    os.path.join(APP_DIR, AGE_REFERENCE_FILENAME),
    os.path.join(BASE_DIR, "outputs", AGE_REFERENCE_FILENAME),
)
...
def load_age_reference_ranges() -> dict | None:
    """Load the empirically derived age-adjusted Beta Score reference ranges."""
    for path in AGE_REFERENCE_CANDIDATES:
...
def _resolve_age_figure_path(filename: str) -> str | None:
    ...
    candidates = (
        os.path.join(APP_DIR, "figures", filename),
        os.path.join(BASE_DIR, "outputs", "figures", filename),
    )
