...
def setup_wizard():
    ...
    print("\n📝 This wizard will help you set up your Xata database.")
    print("\n" + "─" * 70)

    # Step 1: Account check
    print("\n1️⃣  Xata Account Setup")
    ...
    # Step 3: API Key
    print("\n3️⃣  API Key Setup")
    print_info("In Xata UI, go to: Account Settings → API Keys")
...
def check_status():
    ...
    for table in schema["tables"]:
        ...
        print(f"   • {table['name']:35s} {col_count:2d} columns")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"\n✅ Actual Database ({len(tables)} tables):\n")
            for table in tables:
                print(f"   • {table['name']}")
        else:
...
def validate_against_depmap():
    ...
    if multi_target_table:
        ...
        if effect_file.exists():
            print("\n🔍 Checking target genes in DepMap data...")
            try:
...
def main():
    ...
    print("╔═══════════════════════════════════════════════════════════════════╗")
    print("║  Xata Migration Tool V2 - StarX Therapeutics Analysis            ║")
    print("╚═══════════════════════════════════════════════════════════════════╝")
    print(Colors.ENDC)
